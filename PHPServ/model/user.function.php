...
function update_login( $username, $name, $gender, $mobi, $birthday, $email )
{
	$sql = "UPDATE `login` SET Name = '$name', Gender = '$gender', Mobile = '$mobi', Birthday = '$birthday', Email = '$email' WHERE UserName = '$username'";
	return run_sql( $sql );
	//return $sql;
}